                    ...
                    {data.map((item, i) => {
                        ...
                        const tds = Object.entries(columns).map(([colName, field]) => {
                            if (colName === "Статус") {
                                ...
                                return (
                                    <td key={i + colName} onClick={(e) => { e.preventDefault(); onEdit(item.id); }} style={{ cursor: "pointer" }}>
                                        <a href="#">
                                            {item[field]}
                                        </a>
                                    </td>
                                ...
                                return (
                                    <td key={i + colName} onClick={(e) => { e.preventDefault(); onShowUser(user_id); }} style={{ cursor: "pointer" }}>
                                        <a href="#">
                                            {user_full_name}
                                        </a>
                                    </td>
